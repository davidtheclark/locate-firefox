...
function getOSXPath(finisher) {
  var toExec = '/Contents/MacOS/Firefox';
  var regPath = '/Applications/Firefox.app' + toExec;
  var altPath = userhome(regPath.slice(1));
  var mdFindCmd = 'mdfind \'kMDItemDisplayName == "Firefox" && kMDItemKind == Application\'';
...
function getWinPath(finisher) {
  var winSuffix = '\\Mozilla Firefox\\firefox.exe';
  var prefixes = [
